...
<div class="container" style="margin-top: 30px;">
    ...
    <tr>
        <th>Expert Name:</th>
        <td>Harendra Singh (4 years business)</td>
        <td rowspan="4" class="text-center" style="text-align: center;">
            <img src="images/Free Photo _ Medium shot of male farmer facing camera and holding a bowlfull of strawberries.jpg" width="250" />
        </td>
    </tr>
    <tr>
        <th>Course Price:</th>
